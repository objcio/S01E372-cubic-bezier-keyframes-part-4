...
let points: [(Double, duration: TimeInterval, startVelocity: Double?, endVelocity: Double?)] = [
    (-30, duration: 0.5, startVelocity: nil, endVelocity: nil),
    (30, duration: 2, startVelocity: nil, endVelocity: nil),
    (0, duration: 0.5, startVelocity: nil, endVelocity: nil),
]
...
struct ContentView: View {
    ...
    var body: some View {
        let t0 = KeyframeTimeline(initialValue: 0) {
            LinearKeyframe(100, duration: 1)
            CubicKeyframe(50, duration: 0.5)
            LinearKeyframe(75, duration: 1)
//            for point in points {
...
//            }
        ...
        let t1 = MyKeyframeTimeline(initialValue: 0, tracks:
            [
                MyKeyframeTrack(\.self, [
                    MyLinearKeyframe(100, duration: 1),
                    MyCubicKeyframe(50, duration: 0.5),
                    MyLinearKeyframe(75, duration: 1),
                ]
//                                 points.map { p in
